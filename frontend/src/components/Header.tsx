    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white">ScheduGator</h1>
            <p className="text-xs sm:text-sm text-gator-gray-200 hidden sm:block">AI-Driven Academic Schedule Optimizer</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          <button
            ...
            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg transition-all font-semibold"
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gator-accent hover:bg-orange-600 text-white rounded-lg transition-all font-semibold shadow-md whitespace-nowrap"
